...
class BARTHubInterface(GeneratorHubInterface):
    ...
    def encode(
        ...
        print()
        print("----------------------------------------------------------")
        print("class BARTHubInterface")
        print("----------------------")
        print("encode() tally with GPT-2, tokens:",tokens)
        print("bpe_sentence: ", bpe_sentence)
        print("self.task: ", self.task.__class__)
        print("source_dictionary: ", self.task.source_dictionary)
        print("----------------------------------------------------------")
