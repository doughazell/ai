...
class Dictionary:
    ...
    def __init__(
        ...
        *,  # begin keyword-only arguments
        ...
        # 13/1/24 DH: Used for reducing debug in 'token_string()'
        self.iCnt = 0
    ...
    def string(
        ...
        def token_string(i):
            if i == self.unk():
                ...
                # 10/1/24 DH:
                if self.iCnt < 10:
                  print("Dictionary.token_string(): value ('Symbols[idx]'): ", self[i], ", i:", i)
                self.iCnt += 1
        ...
        print("-----------------")
        print("Dictionary.string() 'tensor':",tensor)
        ...
        # 10/1/24 DH:
        print("Dictionary.string() 'sent': ", sent)
    ...
    def add_from_file(self, f):
        ...
        """
        # 10/1/24 DH:
        print("Dictionary.add_from_file(): ",f)
    ...
    def encode_line(
        ...
        for i, word in enumerate(words):
            if add_if_not_exist:
                ...
                # 10/1/24 DH:
                if i < 10:
                  print("Dictionary.encode_line(): idx: ",idx,", word: ",word)

            else:
                idx = self.index(word)

                # 10/1/24 DH:
                print("encode_line(): idx: ",idx,", word: ",word)
