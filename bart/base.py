...
if is_torch_available():
    # 12/1/24 DH:
    print()
    print("*** Torch available so importing from 'transformers.pipelines.pt_utils' ***")
    print()
...
class Pipeline(_ScikitCompat):
    ...
    def __call__(self, inputs, *args, num_workers=None, batch_size=None, **kwargs):
        ...
        # 13/1/24 DH:
        print()
        print("Pipeline::__call__() is_list: ", is_list, ", can_use_iterator: ", can_use_iterator, ", is_iterable: ", is_iterable)
        print("  isinstance(self, ChunkPipeline): ", isinstance(self, ChunkPipeline) )
        print()
        ...
        if is_list:
            if can_use_iterator:
                ...
                # 13/1/24 DH:
                print()
                print("  Return from 'is_list': ",outputs)
